...
export const getBlogContainerFromresponse = (response) => {
    ...
    container[CONTAINERS_KEY.ACTIVE_SUBSCRIPTION] = response?.[CONTAINERS_KEY.ACTIVE_SUBSCRIPTION]
    ...
    container[CONTAINERS_KEY.AUTO_PUBLISH] = response?.[CONTAINERS_KEY.CONTAINERS_PUBLISH_CONFIGS]?.[CONTAINERS_KEY.AUTO_PUBLISH]
